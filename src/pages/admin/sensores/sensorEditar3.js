...
const {idSensor} = useParams();
  ...
  useEffect(()=>{
    ...
    async function getSensor() {
      ...
      setProveniencia1(response.data.proveniencia1);
      setNumDoc1(response.data.numDoc1);
      setDescricaoVisita1(response.data.descricaoVisita1);
      setNumVisitantes1(response.data.numVisitantes1);
      setDataVisita1(response.data.dataVisita1);
      setHoraVisita1(response.data.horaVisita1);
      setOutrosVistitantes1(response.data.outrosVistitantes1);
      setDadosVeiculo1(response.data.dadosVeiculo1);
  ...
  async function handleSubmit1(){
  	...
  	const data = {
        ...
        numDoc1: numDoc1,
          proveniencia1: proveniencia1,
          descricaoVisita1: descricaoVisita1,
          numVisitantes1: numVisitantes1,
          dataVisita1: dataVisita1,
          horaVisita1: horaVisita1,
          outrosVistitantes1: outrosVistitantes1,
          dadosVeiculo1: dadosVeiculo1,
          status1: status1,
  		    _id:idSensor
  	}
	          		 ...
	          		 <Grid container spacing={3} >
							...
							<Grid item xs={12} sm={12}>
					          <TextField
					            ...
					            value={dadosVeiculo1}
					            onChange={e=> setDadosVeiculo1(e.target.dadosVeiculo1)}
					          />
					        </Grid>
